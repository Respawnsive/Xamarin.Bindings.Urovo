...
namespace Xamarin.Bindings.Urovo.Sample
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private void StartScan_Click(object sender, EventArgs e)
        {
            ...
            var test = mScanManager.OpenScanner();
        }
        private void StopScan_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            var test =  mScanManager.CloseScanner();
        }
         
    protected override void OnResume()
        {
            base.OnResume();
            RegisterReceiver(receiver, new global::Android.Content.IntentFilter(ScanManager.ActionDecode));
